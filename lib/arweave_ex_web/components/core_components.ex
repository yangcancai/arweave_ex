defmodule ArweaveExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ArweaveExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ArweaveExWeb.Gettext, "errors", msg, opts)
    end
  end
